...
function NavBar({ currentUser, logout }) {
  return (
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5  sticky top-0 z-10 border-t-0  shadow-md">
        ...
        <div className="flex items-center md:order-2">
          ...
          >
            ...
            <div className="w-8 h-8 rounded-xl  bg-blue-500 flex hover:bg-blue-700">
              <div className="place-self-center flex-1 font-semibold text-white">
                {currentUser[0]}
              </div>
            </div>
          </button>
          ...
          >
            <div className="py-3 px-4">
              <span className="block text-sm text-gray-900">Current User:</span>
